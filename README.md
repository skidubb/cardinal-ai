...
Monorepo for Cardinal Element's agentic AI work — agent systems, orchestration protocols, evaluation frameworks, and automation workflows.
...
### CE - Evals
Evaluation framework for measuring agent and protocol quality — automated rubrics, benchmarking tools, and comparative analysis.
...
### Scripts
Utility scripts shared across projects.

### Shared
Common utilities, types, and configuration shared across projects.

...
ROLE_MCP_SERVERS: dict[str, dict[str, McpServerConfig]] = {
    ...
    "walk-framer": {**_COMMON},
    "walk-systems": {**_COMMON},
    "walk-analogy": {**_COMMON},
    "walk-narrative": {**_COMMON},
    "walk-constraint": {**_COMMON},
    "walk-adversarial": {**_COMMON},
    "walk-salience-judge": {**_COMMON},
    "walk-synthesizer": {**_COMMON},
    "walk-poet": {**_COMMON},
    "walk-historian": {**_COMMON},
    "walk-complexity": {**_COMMON},
    "walk-semiotician": {**_COMMON},
    "walk-economist": {**_COMMON},
    "walk-statistician": {**_COMMON},
